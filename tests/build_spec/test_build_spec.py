...
def _test_build_spec(
    ...
    preprocessing = [
        None if input_.preprocessing is missing else
        [{"name": preproc.name, "kwargs": preproc.kwargs} for preproc in input_.preprocessing]
        for input_ in model_spec.inputs
    ]
    postprocessing = [
        None if output.postprocessing is missing else
        [{"name": preproc.name, "kwargs": preproc.kwargs} for preproc in output.preprocessing]
